...
!--  for refitting with the lineariyed coordinates later 
 ...
 !
  ...
  double precision :: b1,b3,b4,b5,theta1,theta2,theta3,y(NDEG),theta12,theta23,theta13,theta1e,theta2e,theta3e,SAeq,SBeq,Sa,Sb,test
...
!ahh3 = 240.0+tbar+1.0/6.0*sqrt(6.0)*A1-1.0/6.0*sqrt(2.0)*A2  !12
  ...
  !
  ! Sa   = ( 2.0d0*theta23 - theta13 - theta12 )/sqrt(6.0d0) - SAeq
  ! Sb   = (                 theta13 - theta12 )/sqrt(2.0d0) - SBeq
