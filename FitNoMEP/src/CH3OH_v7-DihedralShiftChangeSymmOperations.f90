...
!--  for refitting with the lineariyed coordinates later 
 ...
 !
  ...
  double precision :: b1,b3,b4,b5,theta1,theta2,theta3,y(NDEG),theta12,theta23,theta13,theta1e,theta2e,theta3e,SAeq,SBeq
...
!ahh3 = 240.0+tbar+1.0/6.0*sqrt(6.0)*A1-1.0/6.0*sqrt(2.0)*A2  !12
  ...
  !
  ! write(*, '(A, F20.10, F20.10, F20.10, F20.10, F20.10)'), "point ", theta12, theta13, theta23, xi(10), xi(11)
  !
