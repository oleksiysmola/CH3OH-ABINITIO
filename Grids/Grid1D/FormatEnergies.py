...
df = pd.read_csv("CH3OH-1D-C3V.dat", delim_whitespace=True, names=columns, dtype=str)
...
statesFile = "CH3OH-1D-C3V-Original.energies"
with open(statesFile, "w+") as FileToWriteTo:
    FileToWriteTo.write(df)
print(displacements.to_string(index=False, header=False))
# re1= 1.4296
# re2= 0.95887
# re3= 1.092294
# re4= 1.092294
